...
var _book = _interopRequireDefault(require("../services/book.service"));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _book["default"].getAllBooks();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.prev = 4;
                _context2.next = 7;
                return _book["default"].addBook(newBook);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 5:
                _context3.prev = 5;
                _context3.next = 8;
                return _book["default"].updateBook(id, alteredBook);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                _context4.prev = 4;
                _context4.next = 7;
                return _book["default"].getABook(id);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                _context5.prev = 4;
                _context5.next = 7;
                return _book["default"].deleteBook(id);
